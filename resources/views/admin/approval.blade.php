        ...
        <table class="table table-dark">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn-success" href="{{ route('approvalproduct',[$products->id,'approved'])}}">approved</a>
                        <a  class="btn-danger" href="{{ route('approvalproduct',[$products->id,'declined'])}}">declined</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
